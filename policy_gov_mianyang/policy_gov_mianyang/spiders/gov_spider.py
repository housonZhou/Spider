...
from policy_gov_mianyang.settings import HEADERS, FILES_STORE, RUN_LEVEL, PRINT_ITEM, IMG_ERROR_TYPE, FILE_DOWNLOAD
from policy_gov_mianyang.util import obj_first, RedisConnect, xpath_from_remove, time_map, get_html_content, \
    effective, find_effective_start
...
class GovSpider(scrapy.Spider):
    ...
    def news_style(self, response):
        item = PolicyReformItem()
        file_type = effective_start = effective_end = doc_no = ''
