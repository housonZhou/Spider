...
from Food.heilongjiang_spyp.hlgjg_req import *


def start(time_map, q):
    for i in range(30):
        base_url = 'http://www.hljfda.gov.cn:8888/sp6/index{}.jhtml'
...
if __name__ == '__main__':
    q_link = Queue()
    save_dir = r'C:\Users\17337\houszhou\data\SpiderData\Food\heilongjiang\spyp0624'
    time_end = ''
    th_num = 3
